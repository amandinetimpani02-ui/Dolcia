...
const APP_BUILD = '21.50.0-d-vivante-fun';
...
state.momentQualified=localStorage.getItem('dolcia_moment_qualified_v1')==='1';
...
function renderEclatQuestion(){const target=document.querySelector('#eclatQuestion'),brief=state.eclatBrief;if(!target||!brief)return;const screens=[
  {q:'Quand serez-vous réellement disponible ?',sub:'La date et le créneau déterminent les événements, concerts, spectacles et rendez-vous rares que Dolcia peut trouver.',options:[['now','Maintenant · pour 2 heures'],['tonight','Ce soir · à partir de 18 h'],['tomorrow','Demain · la journée'],['custom','Dates & heures exactes']]},
